...
// import { ProductService } from '../../service/ManagerService.js';
...
//                     alert(res.data)
//                     if (res.status === 200) {
//                         _products[index] = res.data; // אם את רוצה את התשובה מהשרת במקום הישן
//                         func()
...
//                          {totalRecords} products" globalFilter={globalFilter} header={header}>
